...
import 'package:uyobuyo_client/presentation/components/custom_willpop_scope_component.dart';
...
class ChooseLocationInMapPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomWillPopScope(
      onWillPop: true,
      action: () {
        context.read<MainBloc>().add(const MainEvent.initMainPage(chooseMap: true));
      },
      child: Column(
        children: [
          SizedBox(
